use {crate::TOKEN_PROGRAM_ID, solana_address::Address, solana_instruction::AccountMeta};
#[cfg(feature = "resolve")]
use {
...
//         [32 feeQuoteAccount] [32 feePoolTokenAccount] [48 fees] [1 curve_type] [32 curve]
#[cfg(feature = "resolve")]
...
/// Pre-resolved addresses for building a Aldrin v2 swap instruction offline.
pub struct AldrinV2SwapInput {
    pub pool: Address,
...
pub fn build_accounts(input: &AldrinV2SwapInput) -> Vec<AccountMeta> {
    vec![
        AccountMeta::new_readonly(ALDRIN_V2_PROGRAM_ID, false),
        ...
        AccountMeta::new_readonly(input.curve, false),
...
pub async fn resolve(
    ...
    let curve = read_pubkey(&pool_data, OFFSET_CURVE)?;
