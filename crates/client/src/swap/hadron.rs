...
pub async fn resolve(
    ...
    let config_mint_x = crate::read_pubkey(&config_account.data, OFFSET_MINT_X)?;
    let config_mint_y = crate::read_pubkey(&config_account.data, OFFSET_MINT_Y)?;
    ...
    let token_program_x = crate::read_pubkey(&config_account.data, OFFSET_TOKEN_PROGRAM_X)?;
    let token_program_y = crate::read_pubkey(&config_account.data, OFFSET_TOKEN_PROGRAM_Y)?;

    let is_spl_token =
        |p: &Address| *p == crate::TOKEN_PROGRAM_ID || *p == crate::TOKEN_2022_PROGRAM_ID;
    ...
    let curve_meta = crate::read_pubkey(&config_account.data, OFFSET_CURVE_META)?;
    ...
    let vault_x = crate::get_associated_token_address(config, &config_mint_x, &token_program_x);
    let vault_y = crate::get_associated_token_address(config, &config_mint_y, &token_program_y);
    ...
    let user_source = crate::get_associated_token_address(user, mint_x, &token_program_in);
    let user_dest = crate::get_associated_token_address(user, mint_y, &token_program_out);
    ...
    let fee_recipient_ata =
        crate::get_associated_token_address(fee_recipient, mint_x, &token_program_in);
