...
pub enum SwapData<'a> {
    ...
    #[cfg(feature = "meteora-dlmm-swap")]
    MeteoraDlmm(crate::meteora_dlmm::MeteoraDlmmSwapData<'a>),
}
    ...
    pub fn try_from_swap_data(
        ...
        match self {
            ...
            SwapContext::MeteoraDlmm(_) => Ok((
                SwapData::MeteoraDlmm(crate::meteora_dlmm::MeteoraDlmmSwapData::try_from(data)?),
                &[],
            )),
...
pub fn try_from_tagged_swap_context<'info>(
    ...
    match tag {
        ...
        SwapProtocolTag::MeteoraDlmm => {
            ...
            #[cfg(not(feature = "meteora-dlmm-swap"))]
            {
                Err(ProgramError::InvalidInstructionData)
            }
        }
