...
pub enum SwapContext<'info> {
    ...
    #[cfg(feature = "onre-swap")]
    Onre(crate::onre::OnreSwapAccounts<'info>),
}
...
impl<'a> SwapContext<'a> {
    ...
    pub fn try_from_swap_data(
        ...
        match self {
            ...
            #[cfg(feature = "onre-swap")]
            SwapContext::Onre(_) => Ok((SwapData::Onre(()), data)),
...
impl<'a> Swap<'a> for SwapContext<'a> {
    ...
    fn swap_signed(
        ...
        match (ctx, data) {
            ...
            #[cfg(feature = "onre-swap")]
            (SwapContext::Onre(accounts), SwapData::Onre(())) => crate::onre::Onre::swap_signed(
                accounts,
                in_amount,
                minimum_out_amount,
                &(),
...
pub fn try_from_tagged_swap_context<'info>(
    ...
    match tag {
        ...
        SwapProtocolTag::Onre => {
            #[cfg(feature = "onre-swap")]
            {
                validate_tagged_program_account(program_account, &crate::onre::ONRE_PROGRAM_ID)?;
                let ctx = crate::onre::OnreSwapAccounts::try_from(mine)?;
                Ok((SwapContext::Onre(ctx), rest))
            }
            #[cfg(not(feature = "onre-swap"))]
            {
                Err(ProgramError::InvalidInstructionData)
            }
        }
