...
pub enum SwapContext<'info> {
    ...
    #[cfg(feature = "byreal-clmm-swap")]
    ByrealClmm(crate::byreal_clmm::ByrealClmmSwapAccounts<'info>),
}
...
pub enum SwapData<'a> {
    ...
    #[cfg(feature = "byreal-clmm-swap")]
    ByrealClmm(crate::byreal_clmm::ByrealClmmSwapData),
}
...
impl<'a> SwapContext<'a> {
    ...
    pub fn try_from_swap_data(
        ...
        match self {
            ...
            #[cfg(feature = "byreal-clmm-swap")]
            SwapContext::ByrealClmm(_) => {
                let n = crate::byreal_clmm::ByrealClmmSwapData::DATA_LEN;
                let (mine, rest) = split_data_checked(data, n)?;
                Ok((
                    SwapData::ByrealClmm(crate::byreal_clmm::ByrealClmmSwapData::try_from(mine)?),
                    rest,
                ))
            }
...
impl<'a> Swap<'a> for SwapContext<'a> {
    ...
    fn swap_signed(
        ...
        match (ctx, data) {
            ...
            #[cfg(feature = "byreal-clmm-swap")]
            (SwapContext::ByrealClmm(accounts), SwapData::ByrealClmm(d)) => {
                crate::byreal_clmm::ByrealClmm::swap_signed(
                    accounts,
                    in_amount,
                    minimum_out_amount,
                    d,
    ...
    match tag {
        ...
        SwapProtocolTag::ByrealClmm => {
            #[cfg(feature = "byreal-clmm-swap")]
            {
                validate_tagged_program_account(
                    program_account,
                    &crate::byreal_clmm::BYREAL_CLMM_PROGRAM_ID,
                )?;
                let ctx = crate::byreal_clmm::ByrealClmmSwapAccounts::try_from(mine)?;
                Ok((SwapContext::ByrealClmm(ctx), rest))
            }
            #[cfg(not(feature = "byreal-clmm-swap"))]
            {
                Err(ProgramError::InvalidInstructionData)
            }
        }
