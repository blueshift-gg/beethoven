...
pub const OXEDIUM_PROGRAM_ID: Address = address!("oV3SkLhiXSG946FaqDf1yNocFMhE1ZvomGsoWF8Mzap");
...
pub fn oxedium_fixtures_dir() -> String {
    format!("{}/fixtures/swap/oxedium", env!("CARGO_MANIFEST_DIR"))
}
