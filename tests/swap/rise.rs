...
fn test_rise_swap_cpi() {
    ...
    load_and_set_json_fixture(
        &mut svm,
        &format!("{}/mint_token.json", rise_fixtures_dir()),
    );
    load_and_set_json_fixture(&mut svm, &format!("{}/tenant.json", rise_fixtures_dir()));
    load_and_set_json_fixture(&mut svm, &format!("{}/market.json", rise_fixtures_dir()));
    load_and_set_json_fixture(
        &mut svm,
        &format!("{}/cash_escrow.json", rise_fixtures_dir()),
    );
    load_and_set_json_fixture(
        &mut svm,
        &format!("{}/may_tenant.json", rise_fixtures_dir()),
    );
    load_and_set_json_fixture(
        &mut svm,
    ...
    load_and_set_json_fixture(
        &mut svm,
        &format!("{}/market_meta.json", rise_fixtures_dir()),
    );
    load_and_set_json_fixture(
        &mut svm,
        &format!("{}/may_market.json", rise_fixtures_dir()),
    );
    load_and_set_json_fixture(
        &mut svm,
        &format!("{}/liq_vault_main.json", rise_fixtures_dir()),
    );
    load_and_set_json_fixture(
        &mut svm,
    ...
    load_and_set_json_fixture(
        &mut svm,
        &format!("{}/creator_escrow.json", rise_fixtures_dir()),
    );
    load_and_set_json_fixture(
        &mut svm,
        &format!("{}/team_escrow.json", rise_fixtures_dir()),
    );
